...
.\ml\xpu\.venv\Scripts\python.exe `
  .\t008_large_taxonomy_pipeline\build_semantic_blocks.py `
...
```powershell
python .\t008_large_taxonomy_pipeline\make_block_prompts.py `
...
```powershell
python .\t008_large_taxonomy_pipeline\validate_local_decisions.py `
  --block-dir .\data\gold\t008-large-work\ice-makers\blocks `
...
```powershell
python .\t008_large_taxonomy_pipeline\make_global_prompt.py `
...
```powershell
python .\t008_large_taxonomy_pipeline\finalize_global_taxonomy.py `
  --catalog .\data\gold\t008-large-work\ice-makers\local-validated\local-theme-catalog.json `
