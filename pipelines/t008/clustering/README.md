...
```powershell
python .\pipelines\t008\clustering\prepare_t008_candidates.py `
...
```powershell
python .\pipelines\t008\clustering\encode_t008.py `
...
```powershell
python .\pipelines\t008\clustering\cluster_t008.py `
  --input-dir .\data\gold\t008-candidates-20260908-v1 `
...
```powershell
python .\pipelines\t008\clustering\export_human_review.py `
