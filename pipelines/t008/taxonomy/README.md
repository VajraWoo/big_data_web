...
```powershell
python .\pipelines\t008\taxonomy\build_taxonomy_packets.py `
...
```powershell
python .\pipelines\t008\taxonomy\make_taxonomy_prompt.py `
...
```powershell
python .\pipelines\t008\taxonomy\validate_apply_taxonomy.py `
  --packet .\data\gold\t008-taxonomy-packets-20260908-v1\packets\cooktops.json `
